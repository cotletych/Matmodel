...
date: 13 марта, 2022, Москва, Россия
...
![График численности групп](image/1.png){ #fig:001 width=70% height=70% }

## Графики изменения численности во втором случае

![График численности групп](image/2.png){ #fig:002 width=70% height=70% }
...
В ходе выполнения лабораторной работы была изучена модель $SIR$ и построены графики изменения числа особей.